...
ATLAS_LOG_DIR="${ATLAS_LOG_DIR:-/opt/apache-atlas-2.4.0/logs}"
...
HIVE_CP_EXCLUDE_LIST="log4j-slf4j-impl\|log4j-1.2-api\|log4j-api\|log4j-core\|log4j-web\|jersey-json\|jersey-core"
...
HADOOP_CP=$(hadoop classpath | sed 's/:\/[^:]*jersey-json[^:]*\.jar//g')



CP="${HIVE_CP}:${HADOOP_CP}:${ATLASCPPATH}:/opt/apache-atlas-2.4.0/hook-bin/log4j-1.2.17.jar:/opt/apache-atlas-2.4.0/hook-bin/slf4j-log4j12-1.7.30.jar:/opt/apache-atlas-2.4.0/server/webapp/atlas/WEB-INF/lib/jersey-core-1.19.jar:/opt/apache-atlas-2.4.0/hook/hive/atlas-hive-plugin-impl/jersey-json-1.19.jar:/opt/apache-atlas-2.4.0/server/webapp/atlas/WEB-INF/lib/jackson-jaxrs-json-provider-2.12.7.jar:/opt/apache-atlas-2.4.0/server/webapp/atlas/WEB-INF/lib/jackson-jaxrs-base-2.12.7.jar:/opt/hadoop-3.3.2/share/hadoop/common/lib/hadoop-auth-3.3.2.jar"
